...
- Pulls the matching base image: `ghcr.io/research-ag/motoko-build:moc-0.16.0`
...
x-base-image:
  ...
  name: &base_name 'ghcr.io/research-ag/motoko-build:moc-0.14.9' # And this
```
...
**Symptoms**: `failed to pull image ghcr.io/research-ag/motoko-build:moc-0.14.9`

**Fix**: GitHub Container Registry may have rate limits. Try:

```bash
docker pull ghcr.io/research-ag/motoko-build:moc-0.14.9
