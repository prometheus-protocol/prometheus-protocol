...
import { _SERVICE as AuthService } from '../../../../old_declarations/auth_server/auth_server.did.js';
import { createActor as createOAuthActor } from '../../../../old_declarations/auth/index.js';

// Import an ICRC token's service definition and idlFactory
import { _SERVICE as ICRCService } from '../../../../old_declarations/icrc1_ledger/icrc1_ledger.did.js';
import { createActor as createIcrcActor } from '../../../../old_declarations/icrc1_ledger/index.js';
