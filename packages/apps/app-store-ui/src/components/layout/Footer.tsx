...
// It's cleaner to manage link data in an array
const protocolLinks = [
  ...
  return (
    <footer className="border-t bg-background px-4 sm:px-6 lg:px-8 relative">
      <div
        className="
          bg-yellow-400/40
          absolute top-0 left-0 w-full h-8px
        "
      />
      <div className="container py-12 mx-auto">
        {/* --- Top section with link columns --- */}
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 border-b pb-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:col-span-2">
            <div>
        ...
        <div className="mt-12 flex items-center justify-center md:justify-end">
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            {/* Using an emoji for the flag is the easiest cross-platform way */}
            <img
