export const idlFactory = ({ IDL }) => {
  const Vars = IDL.Record({
    'CHANNEL_REGISTRY' : IDL.Principal,
    'SUBNET_ANCHOR_REGISTRY' : IDL.Principal,
    'EXCHANGE_RATE' : IDL.Principal,
    'VIDEO_REGISTRY' : IDL.Principal,
    'COLLECTIBLE_SET_REGISTRY' : IDL.Principal,
    'NFT_COLLECTION_REGISTRY' : IDL.Principal,
    'ICP_LEDGER' : IDL.Principal,
    'ACCOUNT_REGISTRY' : IDL.Principal,
    'CAP_ROUTER' : IDL.Principal,
    'OWNER' : IDL.Principal,
    'NODE_NETWORK' : IDL.Principal,
    'NETWORK' : IDL.Text,
  });
  ...
  const TransferResponse = IDL.Variant({ 'ok' : Balance, 'err' : TransferErr });
  const Balance__1 = IDL.Nat;
  const Result_2 = IDL.Variant({ 'ok' : Balance__1, 'err' : CommonError });
  const Result_10 = IDL.Variant({ 'ok' : IDL.Text, 'err' : CommonError });
  ...
  const Result_8 = IDL.Variant({ 'ok' : MetadataLegacy, 'err' : CommonError });
  const TokenIndex__1 = IDL.Nat32;
  const CollectionDetails = IDL.Record({
    'maxCollectionStorage' : IDL.Nat,
    'name' : IDL.Text,
    'assets' : IDL.Nat,
    'usedCollectionStorage' : IDL.Nat,
    'mintedNfts' : TokenIndex__1,
  });
  const Result_7 = IDL.Variant({ 'ok' : CollectionDetails, 'err' : IDL.Null });
  ...
  const NftDetails = IDL.Record({
    'id' : TokenIdentifier__2,
    'listing' : IDL.Opt(Listing__1),
    'owner' : AccountIdentifier__2,
    'metadata' : IDL.Opt(MetadataV2),
    'index' : TokenIndex__1,
  });
  const Result_6 = IDL.Variant({
    'ok' : IDL.Vec(NftDetails),
    'err' : IDL.Null,
  });
  ...
  const EXTNFT = IDL.Service({
    ...
    'bearer' : IDL.Func([TokenIdentifier__1], [Result_9], ['query']),
    'details' : IDL.Func([TokenIdentifier__1], [Result_13], ['query']),
    ...
    'ext_bearer' : IDL.Func([TokenIdentifier__1], [Result_9], ['query']),
    ...
    'ext_metadata' : IDL.Func([TokenIdentifier__1], [Result_11], ['query']),
    'ext_mint' : IDL.Func(
    ...
    'getLedger' : IDL.Func([], [Result_10], ['query']),
    ...
    'metadata' : IDL.Func([TokenIdentifier__1], [Result_8], ['query']),
    'portal_getCollectionMeta' : IDL.Func([], [Result_7], ['query']),
    'portal_getTokens' : IDL.Func([], [Result_6], ['query']),
    'portal_setIsSoulbound' : IDL.Func([IDL.Bool], [], []),
    'reserve' : IDL.Func(
    ...
    'setLedger' : IDL.Func([IDL.Text], [Result_3], []),
