...
export interface CollectionDetails {
  'maxCollectionStorage' : bigint,
  'name' : string,
  'assets' : bigint,
  'usedCollectionStorage' : bigint,
...
export interface EXTNFT {
  ...
  'bearer' : ActorMethod<[TokenIdentifier__1], Result_9>,
  'details' : ActorMethod<[TokenIdentifier__1], Result_13>,
  ...
  'ext_bearer' : ActorMethod<[TokenIdentifier__1], Result_9>,
  ...
  'ext_metadata' : ActorMethod<[TokenIdentifier__1], Result_11>,
  ...
  'getLedger' : ActorMethod<[], Result_10>,
  ...
  'lock' : ActorMethod<
    ...
    Result_9
  >,
  'metadata' : ActorMethod<[TokenIdentifier__1], Result_8>,
  'portal_getCollectionMeta' : ActorMethod<[], Result_7>,
  'portal_getTokens' : ActorMethod<[], Result_6>,
  'portal_setIsSoulbound' : ActorMethod<[boolean], undefined>,
  'reserve' : ActorMethod<
  ...
  'setLedger' : ActorMethod<[string], Result_3>,
...
export type Result_11 = { 'ok' : Metadata } |
  { 'err' : CommonError };
export type Result_12 = { 'ok' : [AccountIdentifier__1, bigint] } |
  { 'err' : CommonError };
export type Result_13 = { 'ok' : [AccountIdentifier__1, [] | [Listing]] } |
  { 'err' : CommonError };
...
export type Result_5 = { 'ok' : [AccountIdentifier__1, bigint] } |
  { 'err' : string };
export type Result_6 = { 'ok' : Array<NftDetails> } |
  { 'err' : null };
export type Result_7 = { 'ok' : CollectionDetails } |
  { 'err' : null };
export type Result_8 = { 'ok' : MetadataLegacy } |
  { 'err' : CommonError };
export type Result_9 = { 'ok' : AccountIdentifier__1 } |
  { 'err' : CommonError };
...
export type TransferErr = { 'CannotNotify' : AccountIdentifier } |
...
export interface Vars {
  'CHANNEL_REGISTRY' : Principal,
  'SUBNET_ANCHOR_REGISTRY' : Principal,
  'EXCHANGE_RATE' : Principal,
  'VIDEO_REGISTRY' : Principal,
  'COLLECTIBLE_SET_REGISTRY' : Principal,
  'NFT_COLLECTION_REGISTRY' : Principal,
  'ICP_LEDGER' : Principal,
  'ACCOUNT_REGISTRY' : Principal,
  'CAP_ROUTER' : Principal,
  'OWNER' : Principal,
  'NODE_NETWORK' : Principal,
  'NETWORK' : string,
}
